...
# Configuration
# adjust the DATASET and OUTPUT_MODEL paths as needed

DATASET = 'classification/data/data_big.json' 
OUTPUT_MODEL = 'classification/model/pose_classifier_deep.pth'
